...
def busquedaSecuencial(lista,nume):
    ...
    while posicion < len(lista) and not encontrado:
        print(lista,posicion,encontrado)
...
def menu():
    while True:#Menu
        #Opciones de menu
        print('\n--- Programa de ordenamientos y busquedas ---\n')
        ...
        if opcion==1:#Ordenamientos
            ...
            if opcion==1:#Burbuja
               ...
               selectionsort(lista) 
            elif opcion==3:#Insercion
               insercionDirecta(lista) 
            elif opcion==4:#Shell
                ordenShell(lista)
            elif opcion==5:#QuickSort
